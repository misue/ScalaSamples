...
//val edges = Set((1, 2), (1, 3), (1, 4))
//val nodes = Set(0, 1, 2, 3, 4, 5)
//val edges = Set((0, 1), (1, 2), (2, 3), (3, 0), (0, 4), (0, 5))
//  val nodes = List(0, 1, 2, 3, 4, 5, 6, 7)
  val nodeSize = 31
  val nodes = createNodeList(nodeSize)
//  val edges = List((0, 1), (1, 2), (2, 3), (3, 0), (4, 5), (5, 6), (6, 7), (7, 4), (0, 4), (1, 5), (2, 6), (3, 7))
  val edges = createBinTree(nodeSize)

//  private val nodeSize = nodes.size
  private val adj = new Array[Array[Int]](nodeSize)
...
//  private def createNodeList(n: Int): List[Int] = {
//    def createIntList(n: Int): List[Int] = {
//      if (n < 0)
//        List()
//      else
//        n :: createIntList(n - 1)
//    }
//    createIntList(n).reverse
//  }
